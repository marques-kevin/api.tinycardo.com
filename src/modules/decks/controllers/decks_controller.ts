...
import { GetDecksDto } from '@/modules/decks/dtos/get_decks.dto';
import { CreateDeckDto } from '@/modules/decks/dtos/create_deck.dto';
import { UpdateDeckDto } from '@/modules/decks/dtos/update_deck.dto';
import { DeleteDeckDto } from '@/modules/decks/dtos/delete_deck.dto';
import { DuplicateDeckDto } from '@/modules/decks/dtos/duplicate_deck.dto';
import { SearchDecksDto } from '@/modules/decks/dtos/search_decks.dto';
import { UpsertCardsDto } from '@/modules/decks/dtos/upsert_cards.dto';
...
export class DecksController {
  ...
  @Post('/get_decks')
  async get_decks(@User() user: UsersEntity, @Body() body: GetDecksDto) {
  ...
  @Post('/search_decks')
  async search_decks(@Body() body: SearchDecksDto) {
  ...
  @UseGuards(JwtAuthGuard)
  @Post('/create_deck')
  async create_deck(@User() user: UsersEntity, @Body() body: CreateDeckDto) {
  ...
  @UseGuards(JwtAuthGuard)
  @Post('/update_deck')
  async update_deck(@User() user: UsersEntity, @Body() body: UpdateDeckDto) {
  ...
  @UseGuards(JwtAuthGuard)
  @Post('/delete_deck')
  async delete_deck(@User() user: UsersEntity, @Body() body: DeleteDeckDto) {
  ...
  @UseGuards(JwtAuthGuard)
  @Post('/upsert_cards')
  async upsert_cards(@User() user: UsersEntity, @Body() body: UpsertCardsDto) {
