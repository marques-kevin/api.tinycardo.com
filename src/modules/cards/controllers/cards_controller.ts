...
import { CardsGetCardsHandler } from '@/modules/cards/handlers/cards_get_cards_handler';
import { CardsCreateCardHandler } from '@/modules/cards/handlers/cards_create_card_handler';
import { CardsUpdateCardHandler } from '@/modules/cards/handlers/cards_update_card_handler';
import { CardsDeleteCardHandler } from '@/modules/cards/handlers/cards_delete_card_handler';
import { GetCardsDto } from '@/modules/cards/dtos/get_cards.dto';
import { CreateCardDto } from '@/modules/cards/dtos/create_card.dto';
import { UpdateCardDto } from '@/modules/cards/dtos/update_card.dto';
import { DeleteCardDto } from '@/modules/cards/dtos/delete_card.dto';
...
export class CardsController {
  ...
  @Post('/get_cards')
  async get_cards(@User() user: UsersEntity, @Body() body: GetCardsDto) {
  ...
  @UseGuards(JwtAuthGuard)
  @Post('/create_card')
  async create_card(@User() user: UsersEntity, @Body() body: CreateCardDto) {
  ...
  @UseGuards(JwtAuthGuard)
  @Post('/update_card')
  async update_card(@User() user: UsersEntity, @Body() body: UpdateCardDto) {
  ...
  @UseGuards(JwtAuthGuard)
  @Post('/delete_card')
  async delete_card(@User() user: UsersEntity, @Body() body: DeleteCardDto) {
